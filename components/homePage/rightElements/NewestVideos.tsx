            ...
            <div className='flex my-6 relative'>
              <div className='relative'>
                <Link href='#'>
                  ...
                  <span className='absolute right-0.5 bottom-0.5 text-[10px] text-amber-50'>2:37</span>
                </Link>
              </div>
              <span className='text-[10px] text-gray-400 ms-2'>تالار فراهانی</span>
