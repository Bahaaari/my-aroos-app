    ...
    <div className='w-full mb-2'>
      <div className='w-full h-60 grid grid-cols-6 mb-2'>
        <div className='col-span-2 relative shadow-md me-2'>
          ...
          <div className='absolute top-20 left-10'>
            <span className='text-lg font-semibold'>سفارش انواع کیک</span>
          </div>
        </div>
        ...
        <div className='col-span-4 relative shadow-md'>
          ...
          />
          <div className='absolute top-20 left-10'>
            <span className='text-lg font-semibold'>جواهرات عروس و داماد</span>
          </div>
        </div>
      </div>
      ...
      <div className='w-full h-60 grid grid-cols-6'>
        <div className='col-span-4 relative shadow-md me-2'>
          ...
          />
          <div className='absolute top-20 left-10'>
            <span className='text-lg font-semibold'>خدمات کترینگ عروسی</span>
          </div>
        </div>
        ...
        <div className='col-span-2 relative shadow-md'>
          ...
          />
          <div className='absolute top-20 left-10'>
            <span className='text-lg font-semibold'>معرفی گروههای موسیقی</span>
          </div>
        </div>
      </div>
    </div>
