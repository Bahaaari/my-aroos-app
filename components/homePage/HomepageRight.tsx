    ...
    <div className='col-span-2 h-full me-2'>
        <div className='mb-2 shadow-md'>
            <Link href='#'>
                  ...
                  <span className='text-center inline-block align-text-middle text-white text-sm bg-amber-900 w-full h-12'>
                    20 درصد تخفیف انواع ساعت
                  </span>
            </Link>
        </div>
        <div className='mb-2 shadow-md'>
            <Link href='#' >
                  ...
                  <span className='block text-center text-sm bg-white text-[#7da7b8] px-8 py-4'>
                    حراج جواهرات زمردیان
                  </span>
            </Link>
        </div>
        <div className='mb-2 shadow-md'>
